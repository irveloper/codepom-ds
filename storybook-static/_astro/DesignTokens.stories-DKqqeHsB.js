const i={title:"Foundations/Colors & Tokens"},e={parameters:{layout:"fullscreen"},render:()=>`
    <div style="font-family:'Space Grotesk',sans-serif;background:#0B132B;color:#F8FAFC;padding:40px;min-height:100vh;">
      <div style="max-width:800px;margin:0 auto;">
        ...
        <div style="border:1px solid #1C2541;border-radius:12px;overflow:hidden;">
          ${[{name:"background",val:"#0B132B",bg:"#0B132B",use:"App canvas"},{name:"foreground",val:"#F8FAFC",bg:"#F8FAFC",use:"Body text"},{name:"card",val:"#08192E",bg:"#08192E",use:"Panels & cards"},{name:"primary",val:"#FBB040",bg:"#FBB040",use:"Primary actions"},{name:"secondary",val:"#1C2541",bg:"#1C2541",use:"Secondary surface"},{name:"accent",val:"#00DFFF",bg:"#00DFFF",use:"Highlights & status"},{name:"muted",val:"#3A506B",bg:"#3A506B",use:"Muted / disabled"},{name:"border",val:"#1C2541",bg:"#1C2541",use:"Dividers & borders"}].map(o=>`
            <div style="display:flex;align-items:center;gap:14px;padding:11px 16px;border-bottom:1px solid #131f3a;">
              <span style="width:26px;height:26px;flex:none;border-radius:6px;border:1px solid #1C2541;background:${o.bg};"></span>
              <span style="font-family:'Space Mono',monospace;font-size:13px;color:#FBB040;min-width:170px;">--${o.name}</span>
              <span style="font-family:'Space Mono',monospace;font-size:12px;color:#64748B;">${o.val}</span>
              <span style="margin-left:auto;font-size:13px;color:#94A3B8;">${o.use}</span>
            </div>
          `).join("")}
        </div>
      </div>
  ...
  \`
}`,...e.parameters?.docs?.source}}};const d=["ColorPalette"];export{e as ColorPalette,d as __namedExportsOrder,i as default};
