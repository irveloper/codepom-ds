const o=()=>{throw new Error("Astro components are rendered server-side by Storybook.")};o.isAstroComponentFactory=!0;o.moduleId="/Users/irveloper/Downloads/Design system creation/codepom-design-system/src/components/Card.astro";const s={title:"Components/Card",component:o},e={parameters:{slots:{default:`
...
}`,...i.parameters?.docs?.source}}};const n=["FeatureCard","StatCard","ProfileCard"];export{e as FeatureCard,i as ProfileCard,t as StatCard,n as __namedExportsOrder,s as default};
