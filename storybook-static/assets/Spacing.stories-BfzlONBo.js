const a={title:"Foundations/Spacing"},n=[{token:"--cp-space-0",px:"0px",step:0},{token:"--cp-space-1",px:"4px",step:1},{token:"--cp-space-2",px:"8px",step:2},{token:"--cp-space-3",px:"12px",step:3},{token:"--cp-space-4",px:"16px",step:4},{token:"--cp-space-5",px:"20px",step:5},{token:"--cp-space-6",px:"24px",step:6},{token:"--cp-space-8",px:"32px",step:8},{token:"--cp-space-10",px:"40px",step:10},{token:"--cp-space-12",px:"48px",step:12},{token:"--cp-space-16",px:"64px",step:16},{token:"--cp-space-20",px:"80px",step:20},{token:"--cp-space-24",px:"96px",step:24}],p={name:"Scale",parameters:{layout:"fullscreen"},render:()=>`
      ...
      <div style="max-width:780px;margin:0 auto;">
          ...
          ${n.map(e=>`
            <div style="display:flex;align-items:center;gap:16px;padding:10px 0;border-bottom:1px solid #131f3a;">
              <div style="width:200px;flex:none;display:flex;align-items:baseline;gap:8px;">
                <span style="font-family:'Space Mono',monospace;font-size:13px;color:#FBB040;">${e.token}</span>
              </div>
              <div style="width:40px;flex:none;text-align:right;font-family:'Space Mono',monospace;font-size:12px;color:#64748B;">${e.px}</div>
              <div style="flex:1;display:flex;align-items:center;gap:0;">
                ${e.step===0?`<span style="font-size:11px;color:#3A506B;font-family:'Space Mono',monospace;">—</span>`:`<div style="height:20px;width:${e.px};background:linear-gradient(90deg,#FBB040,#00DFFF);border-radius:3px;min-width:2px;"></div>`}
              </div>
            </div>
          `).join("")}
        </div>
        ...
        <div style="margin-top:48px;">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
            ${[{use:"Icon gap",token:"--cp-space-1",px:"4px"},{use:"Inline gap",token:"--cp-space-2",px:"8px"},{use:"Button padding-x",token:"--cp-space-4",px:"16px"},{use:"Card padding",token:"--cp-space-6",px:"24px"},{use:"Section gap",token:"--cp-space-8",px:"32px"},{use:"Page padding",token:"--cp-space-10",px:"40px"},{use:"Section spacer",token:"--cp-space-16",px:"64px"},{use:"Hero gap",token:"--cp-space-24",px:"96px"}].map(e=>`
              <div style="background:#08192E;border:1px solid #1C2541;border-radius:10px;padding:14px 16px;display:flex;justify-content:space-between;align-items:center;">
                ...
                <span style="font-family:'Space Mono',monospace;font-size:12px;color:#FBB040;">${e.token}</span>
              </div>
            `).join("")}
          </div>
        </div>
  ...
  `},s={name:"Playground",parameters:{layout:"centered"},render:()=>`
    <div style="font-family:'Space Grotesk',sans-serif;background:#08192E;border:1px solid #1C2541;border-radius:16px;padding:32px;display:flex;flex-direction:column;gap:0;min-width:420px;">
      ...
      <div style="display:flex;flex-direction:column;gap:0;">
        ${[1,2,3,4,5,6,8,10].map(e=>`
            <div style="display:flex;align-items:center;margin-bottom:${e===1?4:e===2?8:e===3?12:e===4?16:e===5?20:e===6?24:e===8?32:40}px;gap:12px;">
              ...
              <span style="font-family:'Space Mono',monospace;font-size:10px;color:#3A506B;flex:none;">mb:space-${e}</span>
            </div>
          `).join("")}
      </div>
    </div>
        ...
        <div style="display:flex;flex-direction:column;gap:4px;">
          \${steps.map(s => \`
            <div style="display:flex;align-items:center;gap:16px;padding:10px 0;border-bottom:1px solid #131f3a;">
              ...
              <div style="flex:1;display:flex;align-items:center;gap:0;">
                \${s.step === 0 ? \`<span style="font-size:11px;color:#3A506B;font-family:'Space Mono',monospace;">—</span>\` : \`<div style="height:20px;width:\${s.px};background:linear-gradient(90deg,#FBB040,#00DFFF);border-radius:3px;min-width:2px;"></div>\`}
              </div>
            </div>
          \`).join('')}
        </div>
  ...
  \`
}`,...s.parameters?.docs?.source}}};const t=["Scale","Playground"];export{s as Playground,p as Scale,t as __namedExportsOrder,a as default};
